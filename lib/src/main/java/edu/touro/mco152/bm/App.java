...
public class App {
    ...
    public static void startBenchmark() {
        ...
        worker = new DiskWorker(new SwingUIImplementation());
        worker.ui.addAPropertyChangeListener((final PropertyChangeEvent event) -> {
